...
local Blips = {
	...
	-- Central
	{ -61.1,-1093.52,26.49,225,62,"Concessionaria",0.4 },
	...
	{ -1228.4,-1459.22,4.31,78,11,"Mercado Central",0.5 },
	...
	{ -1874.91,-372.88,49.05,80,38,"Hospital",0.5 },
	{ 1839.43,3672.86,34.27,80,38,"Hospital",0.5 },
	{ -247.42,6331.39,32.42,80,38,"Hospital",0.5 },
	{ 824.42,-994.35,26.37,402,26,"Mecânica",0.7 },
	{ -798.87,-2578.76,13.95,402,26,"Mecânica",0.7 },
	...
	{ 1148.06,-451.09,66.98,88,62,"Faxineiro",0.65 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADINIT
-----------------------------------------------------------------------------------------------------------------------------------------
...
CreateThread(function()
    local Passport = nil
    while true do
        ReplaceHudColourWithRgba(114, 204, 114, 255, 255)
        ReplaceHudColourWithRgba(114, 204, 114, 255, 186)
        Passport = vSERVER.Passport()
        if Passport then
            AddTextEntry('FE_THDR_GTAO', '~b~StormShop ~b~| ~o~ID: ' .. Passport)
        end
        Wait(5000)
    end
end)
