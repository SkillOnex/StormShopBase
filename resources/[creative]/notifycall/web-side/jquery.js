$(document).ready(function(){
	...
	const addNotification = data => {
		...
		const html = `<div class="notification" ${data["code"] === 10 ? `style="border-left: 5px solid #12AC5A;"` : `style="border-left: 5px solid #12AC5A;"`}>
			<div class="content">
				${data["code"] === undefined ? "" : `${data["code"] === 10 ? `<div class="code10">${data["code"]}</div>` : `<div class="code">${data["code"]}</div>`}`}
