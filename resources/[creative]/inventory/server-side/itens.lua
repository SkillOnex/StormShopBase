...
Use = {
		...
		if Application then
			...
			if CoordsAtm then
				...
				if vRP.TakeItem(Passport,Full,1,true,Slot) then
					...
					Hypex.DropServer(CoordsAtm,"dollarsroll",math.random(2500,5000))
	...
	["creators"] = function(source,Passport,Amount,Slot,Full,Item,Split)
				if vRP.TakeItem(Passport,Full,1,true,Slot) then
					TriggerClientEvent("inventory:Update",source,"Backpack")
					TriggerEvent("Salary:Add",Passport,"Creators")
					vRP.SetPermission(Passport,"Creators",1)
					vRP.GiveItem(Passport,"notebook",2)
					vRP.GiveItem(Passport,"backpack",4)
					vRP.GiveItem(Passport,"gemstone",30)
					vRP.SetPremium(source)
					TriggerClientEvent("Notify",source,"verde","Você ativou <b>O Cargo Creators</b>.",5000)
			else
				if vRP.HasPermission(Passport,"Creators",1) and vRP.TakeItem(Passport,Full,1,true,Slot) then
					TriggerClientEvent("inventory:Update",source,"Backpack")
					TriggerEvent("Salary:Add",Passport,"Creators")
					vRP.SetPermission(Passport,"Creators",1)
	...
	["lockpick"] = function(source,Passport,Amount,Slot,Full,Item,Split)
		...
		if homeName then
			...
			if vTASKBAR.Task(source,6,15500) then
