...
-- CONNECTION
-----------------------------------------------------------------------------------------------------------------------------------------
vSERVER = Tunnel.getInterface("hypex_busao")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Blip = nil
			...
			if IsPedInAnyVehicle(Ped) then
				...
				if GetEntityArchetypeName(Vehicle) == "bus" then
					...
					if Distance <= 200 then
						...
						DrawMarker(22,Locations[Selected]["x"],Locations[Selected]["y"],Locations[Selected]["z"] + 3.0,0.0,0.0,0.0,0.0,180.0,0.0,7.5,7.5,5.0,18, 172, 100,100,0,0,0,1)
