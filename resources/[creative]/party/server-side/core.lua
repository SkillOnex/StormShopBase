...
-----------------------------------------------------------------------------------------------------------------------------------------
Hypex = {}
Tunnel.bindInterface("party",Hypex)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Config = {
...
-- GETMEMBERS
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.GetMembers(Number)
	local source = source
	local Passport = vRP.Passport(source)
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.CreateRoom(Name,Password)
	local source = source
	local Passport = vRP.Passport(source)
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.EnterRoom(Number, Password)
	local source = source
	local Passport = vRP.Passport(source)
	...
	if Config["Room"][Number] then
		if Config["Users"][Passport] then
			if Number ~= Config["Users"][Passport] then
				if Config["Users"][Passport] then
					Hypex.LeaveRoom(Config["Users"][Passport])
				end
...
-- KICKROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.KickRoom(Kick,Passport)
	local source = source
