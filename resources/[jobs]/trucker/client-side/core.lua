...
-----------------------------------------------------------------------------------------------------------------------------------------
Hypex = {}
Tunnel.bindInterface("trucker",Hypex)
			...
			if IsEntityAVehicle(Vehicle) then
				...
				if Truckers[vehModel] then
					...
					if Distance <= 200 then
						...
						DrawMarker(21,packService[Service]["Coords"][Position][1],packService[Service]["Coords"][Position][2],packService[Service]["Coords"][Position][3] + 1,0,0,0,0,180.0,130.0,3.0,3.0,2.0,18, 172, 100,100,0,0,0,1)
