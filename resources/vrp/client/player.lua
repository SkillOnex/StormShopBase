...
AddEventHandler("vRP:Active",function(Passport,Name)
	...
	SetDiscordAppId(1126989078445953094)
	SetDiscordRichPresenceAsset("icon")
	SetRichPresence(Passport.." - "..Name)
	SetDiscordRichPresenceAssetSmall("Storm Shop")
	SetDiscordRichPresenceAssetText("Storm Shop")
	SetDiscordRichPresenceAssetSmallText("Storm Shop")
	-- SetDiscordRichPresenceAction(0, "Adquira ja sua base", "https://discord.gg/BB4CmjrtQu")
	-- SetDiscordRichPresenceAction(1, "Video", "https://www.youtube.com/@hypexshop2523")
...
function ReloadCharacter(Pid,Ped)
	...
	ReplaceHudColourWithRgba(18, 172, 100,226,255)
