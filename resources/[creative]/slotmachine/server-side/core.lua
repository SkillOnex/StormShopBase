...
-----------------------------------------------------------------------------------------------------------------------------------------
Hypex = {}
Tunnel.bindInterface("slotmachine",Hypex)
...
-- STARTSLOTS
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.StartSlots(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Machines[Table] then
		local Result = {
...
-- WINNER
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Winner(Table,Result)
	local source = source
	local Passport = vRP.Passport(source)
