...
-----------------------------------------------------------------------------------------------------------------------------------------
connectionpolice = {}
Tunnel.bindInterface("police",connectionpolice)
...
local Preset = {
	["mp_m_freemode_01"] = {
		...
		["pants"] = { item = 40, texture = 3 },
		["vest"] = { item = 130, texture = 0 },
...
-- INITPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function connectionpolice.initPrison(nuser_id,services,fines,text)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		if actived[Passport] == nil then
			...
			if Identity then
				...
				if fines > 0 then
					exports["bank"]:AddFines(nuser_id,Passport,Value,Message)
				end
...
-- SEARCHUSER
-----------------------------------------------------------------------------------------------------------------------------------------
function connectionpolice.searchUser(nuser_id)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- INITFINE
-----------------------------------------------------------------------------------------------------------------------------------------
function connectionpolice.initFine(nuser_id,fines,text)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and fines > 0 then
		if actived[Passport] == nil then
			...
			exports["bank"]:AddFines(nuser_id,Passport,fines,text)
...
-- REDUCEPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function connectionpolice.reducePrison()
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
