...
vRP.Prepare("characters/addLikes","UPDATE characters SET likes = likes + @likes WHERE id = @id")
vRP.Prepare("characters/remLikes","UPDATE characters SET likes = likes - @likes WHERE id = @id")
vRP.Prepare("characters/addUnLikes","UPDATE characters SET unlikes = unlikes + @unlikes WHERE id = @id")
vRP.Prepare("characters/remUnLikes","UPDATE characters SET unlikes = unlikes - @unlikes WHERE id = @id")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PLAYERDATA
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.Prepare("bannedsFull/GetBannedFull","SELECT * FROM banneds WHERE license = @license OR fivem = @fivem OR fivem2 = @fivem2 OR discord = @discord OR xbl = @xbl OR liveid = @liveid OR ip = @ip") -- MANTER123
vRP.Prepare("banneds/RemoveBanned","DELETE FROM banneds WHERE license = @license")
vRP.Prepare("banneds/InsertBanned","INSERT INTO banneds(license,time,fivem,fivem2,discord,xbl,liveid,ip) VALUES(@license,UNIX_TIMESTAMP() + 86400 * @time,@fivem,@fivem2,@discord,@xbl,@liveid,@ip)")
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHESTS
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.Prepare("fines/Check1","SELECT * FROM fines WHERE Passport = @Passport")
-----------------------------------------------------------------------------------------------------------------------------------------
-- TAXS
-----------------------------------------------------------------------------------------------------------------------------------------
