...
-----------------------------------------------------------------------------------------------------------------------------------------
Hypex = {}
Tunnel.bindInterface("shops",Hypex)
...
-- TRUNKCHEST:UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.updateShops(action)
...
local List = {
	...
	{ 2556.03,381.14,109.04,"DepartamentMecanico",true },
	...
	{ 1728.63,6416.13,35.49,"DepartamentMecanico",true },
	{ 548.96,2670.17,42.59,"Departament",true },
	{ 1959.72,3741.19,32.75,"Departament",true },
	{ 2677.15,3280.19,55.66,"DepartamentMecanico",true },
	...
	{ 1165.29,2710.55,38.56,"DepartamentMecanico",true },
	{ -1486.9,-377.76,40.55,"Departament",true },
	{ -1221.54,-907.69,12.73,"Departament",true },
	{ 812.72,-781.17,26.56,"DepartamentMecanico",true },
	{ 812.72,-781.17,26.56,"DepartamentMecanico",true },
	-- Criminal (Ilegal)
	...
	-- Cassino (Framework)
	{ 982.83,-111.87,74.16,354.34,"Cassino",false },
	...
	-- Paramedico (Public)
	{ -677.19,334.8,83.09,"Paramedico",false },
	
	-- Policia (Public)
	{ 276.47,-348.05,50.31,"Policia",false },
	{ -2104.69,-444.34,12.1,"Policia",false },
	{ 1325.46,1245.54,114.04,"Policia",false },
	
	-- Mecanico (Public)
	{ 1189.63,2636.54,38.39,"Harmony",false },
	{ 741.62,-830.26,26.0,"Mecanico",false },
	
	-- (Market)
	{ -1225.28,-1440.04,4.73,"Brewery",false },
	{ -1194.68,-891.96,13.99,"CoolBeans",true }, -- BurgerShop open
	{ -380.46,265.97,86.46,"LastTrain",false },
	{ 1995.13,3722.02,34.93,"LastTrain",false },
