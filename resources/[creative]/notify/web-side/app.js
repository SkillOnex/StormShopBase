const preset = {
    ...
    "paramedic": {
        ...
        "background": "linear-gradient(90deg, rgba(0, 255, 210, 0.1) 0%, rgba(0, 255, 210, 0) 97.94%)",
        "lightBackground": "radial-gradient(50% 50% at 50% 50%, rgba(0, 255, 210, 0.4) 0%, rgba(0, 255, 210, 0.0375) 85.42%, rgba(0, 255, 210, 0) 100%)"
    },
