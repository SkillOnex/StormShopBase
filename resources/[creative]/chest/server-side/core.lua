...
-----------------------------------------------------------------------------------------------------------------------------------------
Hypex = {}
Tunnel.bindInterface("chest",Hypex)
...
-- PERMISSIONS
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Permissions(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Store(Item,Slot,Amount,Target)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Take(Item,Slot,Amount,Target)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport and Open[Passport] then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Update(Slot,Target,Amount)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport and Open[Passport] then
