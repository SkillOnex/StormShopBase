...
function ye(e) {
    ...
    return {
        c() {
            t = v("div"), n = v("div"), r = v("span"), s = Q(o), i = C(), d = v("span"), a = Q(f), m = C(), h = v("div"), u = v("button"), w = $("svg"), y = $("path"), T = C(), B = v("div"), _ = v("input"), p = C(), x = v("button"), M = $("svg"), P = $("path"), l(r, "class", "text-base text-white/50 font-normal tracking-wider"), l(d, "class", "text-base text-white/70 font-normal tracking-wider"), l(n, "class", "flex flex-row items-center justify-between"), l(y, "d", "M7 0.999999L0.999999 7L7 13"), l(y, "stroke", "#12ac5a"), l(y, "stroke-width", "2"), l(y, "stroke-linecap", "round"), l(y, "stroke-linejoin", "round"), l(w, "class", "w-2 h-[0.875rem] grid place-items-center"), l(w, "viewBox", "0 0 8 14"), l(w, "fill", "none"), l(w, "xmlns", "http://www.w3.org/2000/svg"), u.disabled = A = e[1][e[22].key] <= e[22].min, l(u, "class", "w-12 h-14 grid place-items-center hover:bg-cr/10"), l(_, "type", "range"), l(_, "min", j = e[22].min), l(_, "max", I = e[22].max), l(_, "step", E = e[22].max < 1 ? "0.01" : e[22].step || "1"), l(_, "class", "w-[17.5rem] h-1 bg-cr/10 outline-none appearance-none rounded svelte-1vyyw8w"), l(B, "class", "w-[20.25rem] h-14 grid place-items-center"), l(P, "d", "M1 13L7 7L1 1"), l(P, "stroke", "#12ac5a"), l(P, "stroke-width", "2"), l(P, "stroke-linecap", "round"), l(P, "stroke-linejoin", "round"), l(M, "class", "w-2 h-[0.875rem] grid place-items-center"), l(M, "viewBox", "0 0 8 14"), l(M, "fill", "none"), l(M, "xmlns", "http://www.w3.org/2000/svg"), x.disabled = K = e[1][e[22].key] >= e[22].max, l(x, "class", "w-12 h-14 grid place-items-center hover:bg-cr/10"), l(h, "class", "flex flex-row items-center bg-black/[0.58] overflow-hidden rounded-[0.4375rem]"), l(t, "class", "w-[26.25rem] h-[5.3125rem] flex flex-col space-y-2")
        },
        m(z, V) {
