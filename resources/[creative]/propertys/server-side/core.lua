...
-----------------------------------------------------------------------------------------------------------------------------------------
Hypex = {}
Tunnel.bindInterface("propertys",Hypex)
...
-- OPENCHEST
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.OpenChest(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		local Chest = {}
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Store(Item,Slot,Amount,Target,Name,Mode)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Take(Slot,Amount,Target,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function Hypex.Update(Slot,Target,Amount,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
